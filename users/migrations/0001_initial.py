    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('lecturer', 'Lecturer'), ('dean', 'Dean/HOD'), ('admin', 'Admin'), ('superadmin', 'Super Admin'), ('finance', 'Finance')], max_length=10)),
                ...
                ('level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students_in_level', to='academics.programlevel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_balance', models.DecimalField(decimal_places=2, default=0, help_text='Extra funds available due to overpayment', max_digits=10)),
                ('reference', models.CharField(max_length=100, unique=True)),
                ('date_paid', models.DateTimeField(blank=True, null=True)),
                ('generated_student_id', models.CharField(blank=True, max_length=20, null=True)),
                ('generated_pin', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academics.academicyear')),
                ('courses', models.ManyToManyField(related_name='registered_students', to='academics.programcourse')),
                ('level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registration_level', to='academics.programlevel')),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academics.program')),
                ('semester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academics.semester')),
