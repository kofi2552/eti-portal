...
`,g=`<div data-toast-container-vertical>
  ...
  <div class="sonner-toast-body-row">
    <div data-toast-plain>{{ message }}</div>
  </div>
</div>
`,H=`<div data-toast-container-vertical>
  <div class="sonner-toast-header-row">
    <div class="sonner-toast-title-group">
      <div class="sonner-toast-title">{{title}}</div>
    </div>
    <button type="button" class="sonner-toast-close">
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
</div>`,z=`<div data-toast-container-vertical data-toast-level="success">
  <div class="sonner-toast-header-row">
    <div class="sonner-toast-title-group">
      <div class="sonner-toast-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          <path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" />
        </svg>
      </div>
      <div class="sonner-toast-title">{{message}}</div>
    </div>
    <button type="button" class="sonner-toast-close">
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
`,B=`<div data-toast-container-vertical data-toast-level="info">
  <div class="sonner-toast-header-row">
    <div class="sonner-toast-title-group">
      <div class="sonner-toast-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
`,L=`<div data-toast-container-vertical data-toast-level="warning">
  <div class="sonner-toast-header-row">
    <div class="sonner-toast-title-group">
      <div class="sonner-toast-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
`,D=`<div data-toast-container-vertical data-toast-level="error">
  <div class="sonner-toast-header-row">
    <div class="sonner-toast-title-group">
      <div class="sonner-toast-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
`,S=`<div data-toast-container-vertical>
  <div class="sonner-toast-header-row">
    <div class="sonner-toast-title-group">
      <div class="sonner-toast-icon">
        <div data-toast-promise-running data-show="true"></div>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" data-toast-promise-completed data-show="false">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          <path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z" />
        </svg>
      </div>
      <div class="sonner-toast-title" data-toast-promise-message></div>
    </div>
    <button type="button" class="sonner-toast-close">
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
